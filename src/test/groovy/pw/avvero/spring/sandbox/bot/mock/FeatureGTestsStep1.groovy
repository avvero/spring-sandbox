...
import static pw.avvero.spring.sandbox.bot.mock.CustomMockRestResponseCreators.withResourceAccessException
import static pw.avvero.spring.sandbox.bot.mock.CustomMockRestResponseCreators.withStatus

@SpringBootTest
@ActiveProfiles(profiles = "test")
@ContextConfiguration(classes = [ContainersConfiguration])
@AutoConfigureMockMvc
class FeatureGTestsStep1 extends Specification {
